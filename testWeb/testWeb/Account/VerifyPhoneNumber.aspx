<%@ Page Title="验证电话号码" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="testWeb.Account.VerifyPhoneNumber" %>
