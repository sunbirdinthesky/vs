<%@ Page Title="注册外部登录名" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="testWeb.Account.RegisterExternalLogin" Async="true" %>
