<%@ Page Title="双重身份验证" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="testWeb.Account.TwoFactorAuthenticationSignIn" %>
